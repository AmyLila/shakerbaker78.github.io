// Weather Summary Soda Springs id=5607916
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=e49b9555dc54df76f65cc2c7338a5181&units=imperial";
fetch(apiURL)
...
// Calculate windChill
 ...
 const forcastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=e49b9555dc54df76f65cc2c7338a5181&units=imperial";
 fetch(forcastURL)
     .then((response) => response.json())
     .then((jsObject) => {
    //  console.log(jsObject);
